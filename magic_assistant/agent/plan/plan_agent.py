...
class PlanAgent(BaseAgent):
    ...
    def init(self) -> int:
        self.make_plan_agent: MakePlanAgent = MakePlanAgent(agent_meta=self.agent_meta, globals=self.globals, io=self.io)

        self.execute_action_agent: ExecuteActionAgent = ExecuteActionAgent(agent_meta=self.agent_meta, globals=self.globals, io=self.io)

        self.evaluate_result_agent: EvaluateResultAgent = EvaluateResultAgent(agent_meta=self.agent_meta, globals=self.globals, io=self.io)
